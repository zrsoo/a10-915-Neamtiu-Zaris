            ...
            try:
                ...
                if user_command == "exit":
                    ...
                    if li_words[1] == "person":
                        ...
                        self.__command_manager.register_undo_operation(self.__person_service, UndoHandler.ADD_PERSON, p_id)
                    if li_words[1] == "activity":
                        ...
                        self.__command_manager.register_undo_operation(self.__activity_service, UndoHandler.ADD_ACTIVITY, activity_id)
                    self.__command_manager.clear_redo_operations()
                    ...
                    if li_words[1] == "person":
                        ...
                        self.__command_manager.register_undo_operation(self.__person_service, UndoHandler.DELETE_PERSON,
                                                          self.__activity_service, li_info)
                    elif li_words[1] == "activity":
                        activity = self.__activity_service.delete_activity(int(li_words[2]))
                        self.__command_manager.register_undo_operation(self.__activity_service, UndoHandler.DELETE_ACTIVITY, activity)
                    self.__command_manager.clear_redo_operations()
                    ...
                    if li_words[1] == "person":
                        ...
                        self.__command_manager.register_undo_operation(self.__person_service, UndoHandler.UPDATE_PERSON, person)
                    elif li_words[1] == "activity":
                        ...
                        self.__command_manager.register_undo_operation(self.__activity_service, UndoHandler.UPDATE_ACTIVITY, activity)
                    self.__command_manager.clear_redo_operations()
